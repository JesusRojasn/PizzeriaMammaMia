...
const Carrito = () => {
  const { pedidoCarrito, setPedidoCarrito, totalPedido, setTotalPedido } =
          ...
          return (
            <div key={objeto.id}>
              <div className="cart">
                ...
                <button
                  className="buttonDisminuir"
                  onClick={() => disminuir(objeto)}
                >
                  {" "}
                  -{" "}
                </button>
